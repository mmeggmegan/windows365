...
| Windows 365 integration | Omnissa provides an alternate connection experience and protocol layer on top of Windows 365 Cloud PCs through Horizon, while Microsoft continues to handle Cloud PC provisioning and management through Intune. App Volumes complements Windows 365 by enabling application delivery and lifecycle management independently of the Cloud PC image, helping organizations reduce image sprawl and simplify application updates.|
| Who it's for | End-user computing and virtual desktop teams, and IT administrators operating Horizon environments alongside Windows 365. Organizations seeking a more flexible approach to application delivery and lifecycle management across Windows 365 deployments. |
...
| Contact | **Sales:** Omnissa sales contact page or general inquiry<br>**Support:** [Omnissa Support](https://www.omnissa.com/support/)<br>**Marketplace listing:** [Omnissa Horizon](https://marketplace.microsoft.com/en-us/product/omnissallc.horizon-cloud-service?tab=Overview), [App Volumes](https://marketplace.microsoft.com/en-us/product/omnissallc.euc-appvolumes?tab=Overview) |
